...
import { HeroText, SectionHeading } from '../components/HomePageText';
    ...
    <div>
      ...
      {!loadError && (
        <>
            ...
            <>
              ...
              <section className="mx-auto max-w-6xl px-6 py-14">
                <div className="flex items-baseline justify-between mb-8">
                  <h2 className="font-display text-3xl text-ink"><SectionHeading i18nKey="featuredDestinations" /></h2>
          ...
          <section className="mx-auto max-w-6xl px-6 py-14">
            <div className="flex items-baseline justify-between mb-8">
              <h2 className="font-display text-3xl text-ink"><SectionHeading i18nKey="browseByRegion" /></h2>
          ...
          <section className="mx-auto max-w-6xl px-6 py-14">
            <div className="flex items-baseline justify-between mb-8">
              <h2 className="font-display text-3xl text-ink"><SectionHeading i18nKey="exploreOnMap" /></h2>
            ...
            <>
              ...
              <section className="mx-auto max-w-6xl px-6 py-14">
                <div className="flex items-baseline justify-between mb-10">
                  <h2 className="font-display text-3xl text-ink"><SectionHeading i18nKey="fullIndex" /></h2>
